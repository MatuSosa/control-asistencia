<aside class="main-sidebar">
    ...
    <section class="sidebar">
      ...
      <ul class="sidebar-menu" data-widget="tree">
        ...
        <li><a href="position.php"><i class="fa fa-suitcase"></i> Objetivos</a></li>
        <li class="header">IMPRIMIBLES</li>
        <li><a href="payroll.php"><i class="fa fa-files-o"></i> <span>Reporte Objetivos</span></a></li>
        <li><a href="schedule_employee.php"><i class="fa fa-clock-o"></i> <span>Reporte Vigiladores</span></a></li>
      </ul>
    </section>
    <!-- /.sidebar -->
  </aside>