...
<div class="login-box">
      ...
      <div class="form-group">
            <select class="form-control" name="sucursal">
              ...
              <option value="sj">Átomo sucursal San Juan</option>
              <option value="mza">Átomo sucursal Mendoza</option>
              <option value="cba">Átomo sucursal Córdoba</option>
              <option value="mdlpta">Átomo sucursal Mar del Plata</option>
